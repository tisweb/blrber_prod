...
class SearchMapPlaceWidgetCustom extends StatefulWidget {
  SearchMapPlaceWidgetCustom({
  ...
  @override
  _SearchMapPlaceWidgetCustomState createState() =>
      _SearchMapPlaceWidgetCustomState();
}

class _SearchMapPlaceWidgetCustomState extends State<SearchMapPlaceWidgetCustom>
  ...
  */
  ...
  Future<dynamic> _makeRequest(input) async {
    ...
    final json =
        jsonDecode(response.body); // removed JSON , jsonDecode added by TIS WEB
