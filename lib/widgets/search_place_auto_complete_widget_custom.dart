...
class SearchPlaceAutoCompleteWidgetCustom extends StatefulWidget {
  ...
  @override
  _SearchPlaceAutoCompleteWidgetCustomState createState() =>
      _SearchPlaceAutoCompleteWidgetCustomState();
}

class _SearchPlaceAutoCompleteWidgetCustomState
    extends State<SearchPlaceAutoCompleteWidgetCustom>
  ...
  */
  ...
  Future<dynamic> _makeRequest(input) async {
    String url =
        "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$input&key=${widget.apiKey}&language=${widget.language}&components=country:${widget.components}";
    ...
    // final json = JSON.jsonDecode(response.body); Changes TIS WEB
  ...
  void customListener() {
    Future.delayed(Duration(milliseconds: 500), () {
      //Below mounted has been added by TIS WEB
